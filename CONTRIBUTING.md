# Contribute to WP Admin Notices
...
* [open an issue](https://github.com/felixarntz/wp-admin-notices/issues/new)
...
* push the changes to your fork and [submit a pull request](https://github.com/felixarntz/wp-admin-notices/compare) to the `master` branch
